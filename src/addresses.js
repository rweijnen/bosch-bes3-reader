...
const ALL_ADDRESSES = {
  ...
  Battery: [
    ...
    { name: 'COMPONENT_DEACTIVATION_PROOF', addr: 153, readable: true, priority: true },
    { name: 'COMPONENT_LOCKED', addr: 152, readable: true },
    { name: 'COMPONENT_LOCK_CONFIGURATION', addr: 151, readable: true },
    { name: 'DELIVERED_AH_OVER_LIFETIME', addr: 215, readable: true, priority: true },
    { name: 'DELIVERED_WH_OVER_LIFETIME', addr: 156, readable: true, priority: true },
    { name: 'DEVICE_CERTIFICATE', addr: 224, readable: true, priority: true },
    { name: 'DURATION_IN_THERMAL_PROTECTION', addr: 157, readable: true, priority: true },
    ...
    { name: 'LAST_END_OF_CHARGE_VOLTAGE', addr: 158, readable: true, priority: true },
    { name: 'LED_TEST_PATTERN_ON', addr: 185, readable: true, writable: true },
    { name: 'MANUFACTURING_DATE', addr: 164, readable: true },
    { name: 'MAXIMUM_CHARGING_CURRENT', addr: 159, readable: true, priority: true },
    { name: 'MAXIMUM_PACK_TEMPERATURE', addr: 160, readable: true, priority: true },
    { name: 'MINIMUM_PACK_TEMPERATURE', addr: 161, readable: true, priority: true },
    { name: 'NUMBER_OF_FULL_CHARGE_CYCLES', addr: 150, readable: true, priority: true },
    { name: 'PART_NUMBER', addr: 130, readable: true },
    { name: 'PRESENT_CELL_VOLTAGE', addr: 140, readable: true, priority: true },
    { name: 'PRESENT_FET_TEMPERATURE', addr: 210, readable: true, priority: true },
    { name: 'PRESENT_PACK_TEMPERATURE', addr: 139, readable: true, priority: true },
    { name: 'PRODUCT_CODE', addr: 131, readable: true, priority: true },
    { name: 'PRODUCT_NAME', addr: 155, readable: true, priority: true },
    { name: 'REMAINING_ENERGY', addr: 146, readable: true, priority: true },
    { name: 'REMAINING_ENERGY_FOR_RIDER', addr: 145, readable: true },
    { name: 'SELF_DISCHARGING_RATE', addr: 220, readable: true, priority: true },
    ...
    { name: 'SO_C_LOWER_LIMIT', addr: 162, readable: true, priority: true, writable: true },
    { name: 'SO_C_UPPER_LIMIT', addr: 163, readable: true, priority: true, writable: true },
    { name: 'STATE_OF_CHARGE', addr: 136, readable: true, priority: true },
    { name: 'STATE_OF_HEALTH', addr: 216, readable: true, priority: true },
  ],
  Battery2: [
  ...
  DriveUnit: [
    ...
    { name: 'BIKE_CATEGORY', addr: 6229, readable: true, priority: true },
    { name: 'BIKE_CATEGORY_CONFIGURATION', addr: 6211, readable: true },
    { name: 'BIKE_ID', addr: 6188, readable: true, priority: true },
    { name: 'BIKE_LIGHT', addr: 6172, readable: true, priority: true, writable: true },
    { name: 'BIKE_LIGHT_AVAILABLE', addr: 6176, readable: true, priority: true, writable: true },
    ...
    { name: 'BOOTLOADER_SOFTWARE_VERSION', addr: 6151, readable: true, priority: true },
    ...
    { name: 'DISTRACTED_RIDING_ALERT', addr: 6161, readable: true, priority: true },
    ...
    { name: 'GEARING_SYSTEM', addr: 6187, readable: true, priority: true },
    ...
    { name: 'HARDWARE_VERSION', addr: 6148, readable: true, priority: true },
    ...
    { name: 'MANUFACTURING_DATE', addr: 6199, readable: true, priority: true },
    { name: 'MAXIMUM_ASSISTANCE_SPEED', addr: 6167, readable: true, priority: true },
    ...
    { name: 'MAXIMUM_AVAILABLE_MOTOR_TORQUE', addr: 6263, readable: true, priority: true },
    { name: 'MAXIMUM_GEAR_RATIO', addr: 6166, readable: true },
    { name: 'MAXIMUM_LEGAL_BIKE_SPEED', addr: 6163, readable: true, priority: true },
    ...
    { name: 'ODOMETER', addr: 6168, readable: true, priority: true },
    { name: 'OEM_BIKE_ID', addr: 6238, readable: true, priority: true },
    { name: 'OEM_BIKE_MODEL_ID', addr: 6261, readable: true, priority: true },
    { name: 'OEM_BRAND_IDENTIFIER', addr: 6186, readable: true },
    { name: 'OEM_BRAND_NAME', addr: 6252, readable: true, priority: true },
    ...
    { name: 'PART_NUMBER', addr: 6146, readable: true, priority: true },
    { name: 'POWER_ON_TIME', addr: 6169, readable: true, priority: true },
    { name: 'POWER_ON_TIME_WITH_MOTOR_SUPPORT', addr: 6253, readable: true, priority: true },
    { name: 'PRESENT_PCB_TEMPERATURE', addr: 6276, readable: true, priority: true },
    ...
    { name: 'PRODUCT_CODE', addr: 6147, readable: true, priority: true },
    { name: 'PRODUCT_LINE', addr: 6183, readable: true, priority: true },
    { name: 'PRODUCT_NAME', addr: 6190, readable: true, priority: true },
    ...
    { name: 'REAR_WHEEL_CIRCUMFERENCE_OEM', addr: 6184, readable: true, priority: true },
    { name: 'REAR_WHEEL_CIRCUMFERENCE_USER', addr: 6185, readable: true, priority: true, writable: true },
    ...
    { name: 'REGIO_SPEED_CONFIGURATION', addr: 6269, readable: true, priority: true },
    ...
    { name: 'SERIAL_NUMBER', addr: 6145, readable: true, priority: true },
    { name: 'SET_UDAM_VALUES_PARAMETERS', addr: 4243, readable: false },
    { name: 'SOFTWARE_VERSION', addr: 6150, readable: true, priority: true },
    ...
    { name: 'START_ASSIST_MODE_CONFIGURATION', addr: 6180, readable: true, priority: true, writable: true },
    { name: 'START_ASSIST_MODE_CONFIGURATION_OEM', addr: 6179, readable: true, priority: true },
    { name: 'THROTTLE_CONFIGURATION', addr: 6300, readable: true },
    { name: 'TUNING_DETECTION', addr: 6225, readable: true, priority: true },
  ...
  RemoteControl: [
    ...
    { name: 'BIKE_NAME', addr: 8582, readable: true, priority: true },
    ...
    { name: 'LANGUAGE', addr: 8577, readable: true, priority: true, writable: true },
    ...
    { name: 'LED_COLORS', addr: 8354, readable: true, priority: true, writable: true },
    ...
    { name: 'SERVICE_DUE', addr: 8581, readable: true, priority: true, writable: true },
    ...
    { name: 'TIME', addr: 8226, readable: true, priority: true, writable: true },
    { name: 'TIME_FORMAT', addr: 8579, readable: true, priority: true, writable: true },
    { name: 'TIME_ZONE', addr: 8225, readable: true },
    { name: 'UNITS', addr: 8578, readable: true, priority: true, writable: true },
